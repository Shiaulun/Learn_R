...
setwd("C:/Users/Shiaulun/Desktop/riii-master/final")
...
house$building_age = round(as.integer(Sys.Date() - house$finish_ymd)/365)
head(house)
```
...
#     存回house變數中 [5分]
library(dplyr)
load("C:/Users/Shiaulun/Desktop/riii-master/final/house_danger.RData")
